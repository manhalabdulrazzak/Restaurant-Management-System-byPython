...
root.title("Restaurant Management System | برنامج إدارة مطعم")
...
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Restaurant Management System | برنامج إدارة مطعم",fg="steel blue",bd=10,anchor='w')
...
status = Label(f2,font=('aria', 15, 'bold'),width = 25, text="-By Manhal Abdulrazzak",bd=3,relief=SUNKEN)
